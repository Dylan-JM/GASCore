...
namespace GasTag
{
	...
	GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Abilities_Status_Locked);
	GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Abilities_Status_Eligible);
	
	GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Abilities_Type_Offensive);
	GASCORE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Abilities_Type_Passive);
