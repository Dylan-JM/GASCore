...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "CoreAbilitySystemLibrary|Attributes")
	...
	UFUNCTION(BlueprintCallable, Category= "CoreAbilitySystemLibrary|GameplayEffects")
	...
	UFUNCTION(BlueprintCallable, Category= "CoreAbilitySystemLibrary|GameplayMechanics")
